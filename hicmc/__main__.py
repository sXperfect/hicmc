...
encode_parser.add_argument('--insulation_file', type=str)
encode_parser.add_argument('--insulation_window', type=int)
encode_parser.add_argument('--weights_precision', type=int, default=consts.WEIGHTS_PRECISION_DEFAULT)
encode_parser.add_argument('--domain_mask_statistic', choices=stats.STATISTIC_FUNCS.keys(), default='deviation')
encode_parser.add_argument('--domain_mask_threshold', type=float, default=1)
encode_parser.add_argument('--domain_values_precision', type=int, default=consts.DOMAIN_VALUES_PRECISION_DEFAULT, help='Number of bits used for floating-point compression')
encode_parser.add_argument('--distance_table_precision', type=int, default=consts.DISTANCE_TABLE_PRECISION_DEFAULT, help='Number of bits used for floating-point compression')
encode_parser.add_argument('--balancing', type=str, default='KR')
